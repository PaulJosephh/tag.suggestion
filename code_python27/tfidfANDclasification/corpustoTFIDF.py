...
#--------------------------------------
#arr=countMatrix.getrow(11).toarray()
#top5=arr.argsort()[0]
#for att in top5[-15:]:
#    print vectorizer.get_feature_names()[att]
#print countMatrix.shape
#print countMatrix[2]
#numero de attributos
...
f=open('../../experiments/'+args.resultfile, 'w')
cPickle.dump(topsTF, f)
cPickle.dump(topsTFIDF, f)
#cPickle.dump(tagsw, f)
f.close()
#topsFrq=set(topsTF)
#for prop in topsTFIDF:
#    topsFrq.add(prop)

#print "------"
#arr=tfidf.getrow(11).toarray()
#top5=arr.argsort()[0]
#for att in top5[-15:]:
#    print vectorizer.get_feature_names()[att]
